...
MODEL                   = asbCubeSatACS
MODULES                 = asbCubeSatACS_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\asbCubeSatACS_msf.mexw64
MAKEFILE                = asbCubeSatACS.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2023b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2023b
START_DIR               = C:\ComputerScience\BSE\adcs\Model\cubesatSimSample2\work\cache
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:asbCubeSatACS_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion -LARGEADDRESSAWARE
...
MODELLIB                  = asbCubeSatACS_msf.mexw64
MODELREF_LINK_LIBS        = C:\ComputerScience\BSE\adcs\Model\cubesatSimSample2\work\cache\slprj\sim\asbCubeSatACS\asbCubeSatACSlib.lib
MODELREF_LINK_RSPFILE     = asbCubeSatACS_ref.rsp
COMPILER_COMMAND_FILE     = asbCubeSatACS_comp.rsp
...
asbCubeSatACS_msf.obj : $(START_DIR)\slprj\sim\asbCubeSatACS\asbCubeSatACS_msf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\sim\asbCubeSatACS\asbCubeSatACS_msf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\sim\asbCubeSatACS\asbCubeSatACS_msf.c
